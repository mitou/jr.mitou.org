...
<section id="about">
  ...
  <div class="service flex">
    ...
    <div class="service-one">
      ...
      <h3>スーパークリエータ認定</h3>
      <p>特に顕著な成果を残した方を未踏ジュニアスーパークリエータとして認定します。<a href="https://www.sfc.keio.ac.jp/news/012903.html">慶應義塾大学SFC</a>や<a href="https://cs.sd.tmu.ac.jp/admission_office.html">東京都立大学</a>に推薦枠で出願できます</p>
    </div>
