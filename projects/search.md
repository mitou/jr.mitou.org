...
<div class="projects">
  ...
  <script type="text/javascript">
   ...
   const categories = ['自作', 'LINE', '言語', 'ゲーム', '学習', 'VR', 'Web', 'アプリ', 'SNS', 'IoT', 'デザイン',
		       '音', '水', '筆', '光', 'ツール', '自動', '教育', '生体', '脆弱性', 'ブロック', 'タブレット',
		       '2016', '2021', '2025', '生成', 'AI', 'ゆっくり', 'エンジン', 'モーター', '会議', '制御',
                       '暗号', '学校', '学生', '美容', '動画', '環境', '電磁', 'デバイス', '単語', '危険', 'OS',
                       '小説', '支援',  '最適化', '生物', '予測', 'LLM', '食材', '色', '作文', '練習', 'モデル',
                       '3D', 'CAD', 'GUI', 'ネット', '装置', '対話', 'メモ', '教材', 'ノート', 'ドローン' ];
