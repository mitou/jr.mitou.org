...
layout: post
title: |
  S.M.S.（Solar Management System）太陽の集光し家庭使用のために太陽光を電力、熱、光に変換し、屋内に伝達する機構
description: |
  太陽光から電気・熱・明かりを同時に作り、家庭内でそのまま使えるように変換する新しいエネルギー装置。動的部品がなく静音・長寿命で、電気だけでなく、光や熱も活用でき、停電時にも明かりと電源を確保できます。
