...
thumbnail: /assets/img/thumbnails/2018/toubans.webp
...
<nav>
  <p class='nav prev'><a href='sound_in_the_forest' title='Sound in the forest - 複数のスマートフォンによる「動く音」の表現'>&larr; 前<br>
    Sound in the forest - 複数のスマートフ...</a></p>
  <p class='nav next'><a href='camera_translation' title='写して翻訳'>次 &rarr;<br>
    写して翻訳</a></p>
</nav>
