...
<nav>
  <p class='nav prev'><a href='guinfra' title='GUInfra〜GUIで建てるインフラストラクチャー〜'>&larr; 前<br>
    GUInfra〜GUIで建てるインフラストラクチャー〜</a></p>
  <p class='nav next'><a href='spaghetian' title='Spaghetian - 電気と電磁石だけでCPUを自作する！'>次 &rarr;<br>
