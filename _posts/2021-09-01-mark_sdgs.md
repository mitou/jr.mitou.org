...
thumbnail: /assets/img/thumbnails/2021/sdgs.webp
...
<nav>
  <p class='nav prev'><a href='vr_sandbox' title='VRSandbox：誰でも簡単3Dモデリングツール'>&larr; 前<br>
    VRSandbox：誰でも簡単3Dモデリングツール</a></p>
  <p class='nav next'><a href='cybotanic' title='Cybotanic：サイボーグ化された植物。'>次 &rarr;<br>
