...
<div style='display: flex; flex-wrap: wrap'>
  ...
  <a href="https://twitter.com/intent/tweet?text=GUInfra〜GUIで建てるインフラストラクチャー〜&via=MitouJr&hashtags=未踏ジュニア&related=MitouJr&lang=jp&url={{ site.url }}/projects/2020/guinfra" class="button">ツイートする</a>
</div>
