...
<div style='display: flex; flex-wrap: wrap'>
  ...
  <a href="https://twitter.com/intent/tweet?text=Visible ─ Webアクセシビリティー診断 & 修正提案ツール&via=MitouJr&hashtags=未踏ジュニア&related=MitouJr&lang=jp&url={{ site.url }}/projects/2020/visible" class="button" target="_blank" rel="noopener">ツイートする</a>
</div>
