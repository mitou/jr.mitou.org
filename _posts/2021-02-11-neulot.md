...
<div style='display: flex; flex-wrap: wrap'>
  ...
  <a href="https://twitter.com/intent/tweet?text=neulot - 生体信号を用いたインターフェイスの開発&via=MitouJr&hashtags=未踏ジュニア&related=MitouJr&lang=jp&url={{ site.url }}/projects/2019/neulot" class="button" target="_blank" rel="noopener">ツイートする</a>
</div>
