...
thumbnail: /assets/img/thumbnails/2019/amoyo.webp
...
<nav>
  <p class='nav prev'><a href='smart_vj' title='SmartVJ - 参加型の新しいメディアアート'>&larr; 前<br>
    SmartVJ - 参加型の新しいメディアアート</a></p>
  <p class='nav next'><a href='det_exploit' title='DetExploit - Windows用OSS脆弱性スキャナー'>次 &rarr;<br>
