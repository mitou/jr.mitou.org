...
thumbnail: /assets/img/thumbnails/2021/web_koten.jpg
description: "個展のオンライン開催には開催場所にとらわれないことにより、幅広い方に参加してもらえるメリットがあります。しかし、COVID-19によって現実の個展の代わりとして開催された多くのオンライン個展は「現実の個展を再現すること」が主眼におかれていました。このプロジェクトでは、Webならではの表現方法を追求し、より「ワクワクする」ような個展の開催を目指しました。"
---
