...
thumbnail: /assets/img/thumbnails/2020/align.webp
...
<nav>
  <p class='nav prev'><a href='glider_gun' title='GliderGun - ブラウザOSを簡単に作成できるツール郡'>&larr; 前<br>
    GliderGun - ブラウザOSを簡単に作成できるツール...</a></p>
  <p class='nav next'><a href='critica' title='critica  - 手軽で直感的なリアクション回収ツール'>次 &rarr;<br>
