...
thumbnail: /assets/img/thumbnails/2018/vreath.png
...
{% else %}                         data-src='/assets/img/thumbnails/2018/vreath.png'
...
<div style='display: flex; flex-wrap: wrap'>
  ...
  <a href="https://twitter.com/intent/tweet?text=Vreath - 暗号通貨の入手障壁を下げるための、独自合意アルゴリズムの開発&via=MitouJr&hashtags=未踏ジュニア&related=MitouJr&lang=jp&url={{ site.url }}/projects/2018/vreath" class="button" target="_blank" rel="noopener">ツイートする</a>
</div>
