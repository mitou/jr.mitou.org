...
{% else %}                         data-src='/assets/img/thumbnails/2016/smart_pen.png'
...
<div style='display: flex; flex-wrap: wrap'>
  ...
  <a href="https://twitter.com/intent/tweet?text=スマートペン&via=MitouJr&hashtags=未踏ジュニア&related=MitouJr&lang=jp&url={{ site.url }}/projects/2016/smart_pen" class="button" target="_blank" rel="noopener">ツイートする</a>
</div>
