...
<div style='display: flex; flex-wrap: wrap'>
  ...
  <a href="https://twitter.com/intent/tweet?text=Tea - 仮想経済シミュレーションプラットフォームとゲーム&via=MitouJr&hashtags=未踏ジュニア&related=MitouJr&lang=jp&url={{ site.url }}/projects/2019/tea" class="button">ツイートする</a>
</div>
