...
<div style='display: flex; flex-wrap: wrap'>
  ...
  <a href="https://twitter.com/intent/tweet?text=-Flight Fit VR- 「飛行」をテーマに仮想空間で身体を鍛えるVR作品&via=MitouJr&hashtags=未踏ジュニア&related=MitouJr&lang=jp&url={{ site.url }}/projects/2020/flight_fit_vr" class="button" target="_blank" rel="noopener">ツイートする</a>
</div>
