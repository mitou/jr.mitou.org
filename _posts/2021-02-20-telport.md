...
thumbnail: /assets/img/thumbnails/2021/telport.png
description: "あらゆるデータを複数の周波数と振幅の合成波に変換し、空間と時間を活用した通信を提供するプロトコルです。口頭での伝達が難しいファイルや情報を高速正確に転送することができ、スマホアプリ化により様々な用途への導入も容易で、費用や特別な設備を必要としません。"
---
