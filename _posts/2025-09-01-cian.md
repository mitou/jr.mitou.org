...
layout: post
title: |
  Cian - 書いて、話して、新しい自分を見つける「思案」ができる日記
description: |
  SNS感覚の短文ジャーナルとAI対話を組み合わせ、書くだけで要約・頻出ワード・感情の流れを可視化。振り返り対話で思案を重ね、次に踏み出す一歩を提案する新しいジャーナルアプリです。
permalink: /projects/2025/cian
thumbnail: /assets/img/projects/2025/cian.png
