...
thumbnail: /assets/img/thumbnails/2021/mock_up.webp
...
<div style="display: table; border-collapse: separate; border-spacing: 15px 0; font-size: 70%; width: 100%; padding: 10px 10px; margin-top: 100px; background-color: rgb(40, 161, 58);">
  <p class="nav prev">&larr; 次<br><a href='birds_eye'>Birds eye ぴーちゃん　自転車危険予測アプリ</a></p>
  <p class="nav next">前 &rarr;<br><a href='vr_sandbox'>VRSandbox：誰でも簡単3Dモデリングツール</a></p>
</div>
