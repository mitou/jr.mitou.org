...
thumbnail: /assets/img/thumbnails/2018/touch_buy.webp
...
<nav>
  <p class='nav prev'><a href='corkboard' title='Corkboard - 位置的に管理するメモサービス'>&larr; 前<br>
    Corkboard - 位置的に管理するメモサービス</a></p>
  <p class='nav next'><a href='robot_soccer' title='強化学習を用いたロボットサッカーシミュレーション'>次 &rarr;<br>
