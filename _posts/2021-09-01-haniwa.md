...
thumbnail: /assets/img/thumbnails/2021/haniwa.webp
...
<nav>
  <p class='nav prev'><a href='augment' title='Augment － リアルタイム音階推定を用いた音楽ゲーム'>&larr; 前<br>
    Augment － リアルタイム音階推定を用いた音楽ゲーム</a></p>
  <p class='nav next'><a href='puguette' title='パゲット - 全て3Dプリントされた四足歩行ロボット'>次 &rarr;<br>
