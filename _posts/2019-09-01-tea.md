...
thumbnail: /assets/img/thumbnails/2019/tea.webp
...
<nav>
  <p class='nav prev'><a href='mallet' title='Mallet - モバイル端末用簡易アプリ開発環境'>&larr; 前<br>
    Mallet - モバイル端末用簡易アプリ開発環境</a></p>
  <p class='nav next'><a href='fresh_capsule' title='fresh capsule - 食材管理アプリ'>次 &rarr;<br>
