...
<nav>
  <p class='nav prev'><a href='life_watcher' title='Life Watcher - 急変する持病を持つ人のための警報システム'>&larr; 前<br>
    Life Watcher - 急変する持病を持つ人のための警...</a></p>
  <p class='nav next'><a href='lets_eigo_puzzle' title='Let'sえいごパズル! - 変化するキューブで楽しく学ぶ英単語'>次 &rarr;<br>
