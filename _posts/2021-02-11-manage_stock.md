...
<div style='display: flex; flex-wrap: wrap'>
  ...
  <a href="https://twitter.com/intent/tweet?text=ManageStock - 家庭向け在庫管理アプリ&via=MitouJr&hashtags=未踏ジュニア&related=MitouJr&lang=jp&url={{ site.url }}/projects/2019/manage_stock" class="button" target="_blank" rel="noopener">ツイートする</a>
</div>
