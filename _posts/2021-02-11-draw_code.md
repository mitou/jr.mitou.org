...
<div style='display: flex; flex-wrap: wrap'>
  ...
  <a href="https://twitter.com/intent/tweet?text=DrawCode　〜ブロックをつなげて自由にHTMLを描こう〜&via=MitouJr&hashtags=未踏ジュニア&related=MitouJr&lang=jp&url={{ site.url }}/projects/2017/draw_code" class="button">ツイートする</a>
</div>
