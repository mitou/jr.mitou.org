...
<nav>
  <p class='nav prev'><a href='mer' title='Mer - 多機能電子リコーダー'>&larr; 前<br>
    Mer - 多機能電子リコーダー</a></p>
  <p class='nav next'><a href='glider_gun' title='GliderGun - ブラウザOSを簡単に作成できるツール郡'>次 &rarr;<br>
    GliderGun - ブラウザOSを簡単に作成できるツール...</a></p>
</nav>
