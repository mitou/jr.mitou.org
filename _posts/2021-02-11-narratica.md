...
{% else %}                         data-src='/assets/img/thumbnails/2017/narratica.png'
...
<div style='display: flex; flex-wrap: wrap'>
  ...
  <a href="https://twitter.com/intent/tweet?text=narratica〜ストーリーコンサルタント〜&via=MitouJr&hashtags=未踏ジュニア&related=MitouJr&lang=jp&url={{ site.url }}/projects/2017/narratica" class="button" target="_blank" rel="noopener">ツイートする</a>
</div>
