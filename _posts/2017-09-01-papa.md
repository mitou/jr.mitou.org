...
thumbnail: /assets/img/thumbnails/2017/papa.webp
...
<nav>
  <p class='nav prev'><a href='music_reminder' title='個人の経験に紐づいた楽曲を推薦するスマートフォンアプリケーションの提案'>&larr; 前<br>
    個人の経験に紐づいた楽曲を推薦するスマートフォンアプリケーシ...</a></p>
  <p class='nav next'><a href='anki_cookie' title='暗記クッキー'>次 &rarr;<br>
    暗記クッキー</a></p>
</nav>
