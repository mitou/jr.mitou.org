...
thumbnail: /assets/img/thumbnails/2019/smart_vj.webp
...
<nav>
  <p class='nav prev'><a href='fresh_capsule' title='fresh capsule - 食材管理アプリ'>&larr; 前<br>
    fresh capsule - 食材管理アプリ</a></p>
  <p class='nav next'><a href='amoyo' title='編模様 (あもーよ) イラスト手編み支援アプリ'>次 &rarr;<br>
    編模様 (あもーよ) イラスト手編み支援アプリ</a></p>
</nav>
