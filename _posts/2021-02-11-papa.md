...
<div style='display: flex; flex-wrap: wrap'>
  ...
  <a href="https://twitter.com/intent/tweet?text=学校現場における情報共有やスケジューリングを支援するウェブアプリの提案&via=MitouJr&hashtags=未踏ジュニア&related=MitouJr&lang=jp&url={{ site.url }}/projects/2017/papa" class="button">ツイートする</a>
</div>
