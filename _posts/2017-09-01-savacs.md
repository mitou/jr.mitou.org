...
<nav>
  <p class='nav prev'><a href='narratica' title='narratica〜ストーリーコンサルタント〜'>&larr; 前<br>
    narratica〜ストーリーコンサルタント〜</a></p>
  <p class='nav next'><a href='fall_in_friends' title='Fall in Friends ～東京オリンピックに向けて、日本のインバウンドを変えるアプリを作る ～'>次 &rarr;<br>
