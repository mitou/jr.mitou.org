...
<div style='display: flex; flex-wrap: wrap'>
  ...
  <a href="https://twitter.com/intent/tweet?text=Toubans! -LINEで設定・通知できる当番お知らせサービス&via=MitouJr&hashtags=未踏ジュニア&related=MitouJr&lang=jp&url={{ site.url }}/projects/2018/toubans" class="button" target="_blank" rel="noopener">ツイートする</a>
</div>
