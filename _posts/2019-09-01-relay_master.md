...
<nav>
  <p class='nav prev'><a href='manage_stock' title='ManageStock - 家庭向け在庫管理アプリ'>&larr; 前<br>
    ManageStock - 家庭向け在庫管理アプリ</a></p>
  <p class='nav next'><a href='virtual_presents' title='VirtualPresents - 仮想世界で用いるWebサービス'>次 &rarr;<br>
