...
thumbnail: /assets/img/thumbnails/2018/vreath.webp
...
<nav>
  <p class='nav prev'><a href='smile_meeting_room' title='スマイル会議室 - IoTで会議室の効率的な利用を'>&larr; 前<br>
    スマイル会議室 - IoTで会議室の効率的な利用を</a></p>
  <p class='nav next'><a href='corkboard' title='Corkboard - 位置的に管理するメモサービス'>次 &rarr;<br>
    Corkboard - 位置的に管理するメモサービス</a></p>
</nav>
