...
layout: post
title: |
  Gen5 - A Flexible Image Editing Editor Integrating Natural Language and GUI
description: |
...
permalink: /english/projects/2025/gen5
...
<nav>
  ...
  <p class='nav next'>
    <a href='sr_motor_heart' title='人工心臓に応用するためのシンクロナスリラクタンスモーターの開発'>
      ...
      <br>
      {% if page.lang == 'en' %}
        Development of a Synchronous R...
      {% else %}
...
<script type="application/ld+json">
  {% include project-json-ld.json project_id="gen5" %}
</script>
