...
layout: post
title: |
  TELPort: High-Speed Communication Protocol Using Sound Waves and Transmission/Reception Application via Speaker and Microphone
description: |
...
permalink: /english/projects/2021/telport
thumbnail: /assets/img/projects/2021/telport.webp
...
<nav>
  <p class='nav prev'>
    <a href='cybotanic' title='Cybotanic：サイボーグ化された植物。'>
      &larr; {{ translations.navPrev[lang] }}
      <br>
      {% if page.lang == 'en' %}
        Cybotanic: Cyborg-Enhanced Pla...
      {% else %}
