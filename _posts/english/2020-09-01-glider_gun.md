...
<nav>
  <p class='nav prev'><a href='skimer' title='SKIMER - Easy Task Management with LINE'>&larr; Prev<br>
    SKIMER - Easy Task Management ...</a></p>
  <p class='nav next'><a href='align' title='Align - Emotion Chat Starting from Battery Level'>Next &rarr;<br>
    Align - Emotion Chat Starting ...</a></p>
</nav>
