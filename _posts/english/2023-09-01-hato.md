...
<nav>
  <p class='nav prev'><a href='umeda_sansei_kai' title='Name Attack Power Display Device - Umeda III (Revised)'>&larr; Prev<br>
    Name Attack Power Display Devi...</a></p>
  <p class='nav next'><a href='motion_simulator' title='Creating a Motion Simulator from Scratch'>Next &rarr;<br>
