...
<nav>
  <p class='nav prev'><a href='flight_fit_vr' title='-Flight Fit VR- A VR Project for Physical Training in a Virtual Space with the Theme of "Flight"'>&larr; Prev<br>
    -Flight Fit VR- A VR Project f...</a></p>
  <p class='nav next'><a href='brush_talk' title='Brush Talk: A Communication App for Young Children'>Next &rarr;<br>
