...
<nav>
  <p class='nav prev'><a href='glider_gun' title='GliderGun - A Suite of Tools for Easily Creating Browser-Based Operating Systems'>&larr; Prev<br>
    GliderGun - A Suite of Tools f...</a></p>
  <p class='nav next'><a href='critica' title='critica - A Simple and Intuitive Feedback Collection Tool'>Next &rarr;<br>
