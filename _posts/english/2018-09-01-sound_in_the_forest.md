...
<nav>
  <p class='nav prev'><a href='memory_capsule' title='Memory Capsule - A Social Networking Service Connecting Through Capsules'>&larr; Prev<br>
    Memory Capsule - A Social Netw...</a></p>
  <p class='nav next'><a href='toubans' title='Toubans! - A Duty Notification Service Configurable and Notifiable via LINE'>Next &rarr;<br>
