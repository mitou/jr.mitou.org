...
<nav>
  <p class='nav prev'><a href='hato' title='Hopefully Automatic Train Operation (HATO): Immersive Automatic Model Train Control System'>&larr; Prev<br>
    Hopefully Automatic Train Oper...</a></p>
  <p class='nav next'><a href='bakusoku_agv' title='Development of a New Independent Steering Mechanism and AGV Module Using It'>Next &rarr;<br>
