...
layout: post
title: |
  neulot - Development of an Interface Using Biological Signals
description: |
...
permalink: /english/projects/2019/neulot
thumbnail: /assets/img/projects/2019/neulot.webp
...
<nav>
  <p class='nav prev'>
    <a href='pirka' title='pirka - 会話を通して成長する人工知能技術'>
      &larr; {{ translations.navPrev[lang] }}
      <br>
      {% if page.lang == 'en' %}
        pirka - Artificial Intelligenc...
      {% else %}
