...
<nav>
  <p class='nav prev'><a href='pirka' title='pirka - Artificial Intelligence Technology that Grows Through Conversations'>&larr; Prev<br>
    pirka - Artificial Intelligenc...</a></p>
  <p class='nav next'><a href='abecobe' title='abecobe - A Simple Yet Challenging Puzzle Game'>Next &rarr;<br>
