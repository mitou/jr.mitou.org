...
<nav>
  <p class='nav prev'><a href='3d_printed_brushless_motor' title='Creating a DIY Motor with a 3D Printer'>&larr; Prev<br>
    Creating a DIY Motor with a 3D...</a></p>
  <p class='nav next'><a href='lescued' title='lescued - A System for Generating Preferred Music Using AI'>Next &rarr;<br>
