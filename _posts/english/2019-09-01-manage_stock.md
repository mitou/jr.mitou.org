...
<nav>
  <p class='nav prev'><a href='abecobe' title='abecobe - A Simple Yet Challenging Puzzle Game'>&larr; Prev<br>
    abecobe - A Simple Yet Challen...</a></p>
  <p class='nav next'><a href='relay_master' title='Relay Master'>Next &rarr;<br>
    Relay Master</a></p>
</nav>
