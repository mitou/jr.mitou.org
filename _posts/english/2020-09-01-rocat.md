...
<nav>
  <p class='nav prev'><a href='levo' title='Levo - A Completely New Futuristic Design for Airsoft Guns'>&larr; Prev<br>
    Levo - A Completely New Futuri...</a></p>
  <p class='nav next'><a href='flight_fit_vr' title='-Flight Fit VR- A VR Project for Physical Training in a Virtual Space with the Theme of "Flight"'>Next &rarr;<br>
