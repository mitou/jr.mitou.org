...
permalink: /english/projects/2021/mark_sdgs
thumbnail: /assets/img/projects/2021/sdgs.webp
...
<nav>
  <p class='nav prev'>
    <a href='vr_sandbox' title='VRSandbox：誰でも簡単3Dモデリングツール'>
      &larr; {{ translations.navPrev[lang] }}
      <br>
      {% if page.lang == 'en' %}
        VRSandbox: An Easy 3D Modeling...
      {% else %}
