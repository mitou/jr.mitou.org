...
<nav>
  <p class='nav prev'><a href='vr_sandbox' title='VRSandbox: An Easy 3D Modeling Tool for Everyone'>&larr; Prev<br>
    VRSandbox: An Easy 3D Modeling...</a></p>
  <p class='nav next'><a href='cybotanic' title='Cybotanic: Cyborg-Enhanced Plants.'>Next &rarr;<br>
