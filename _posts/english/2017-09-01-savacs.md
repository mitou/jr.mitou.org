...
<nav>
  <p class='nav prev'><a href='narratica' title='narratica: Story Consultant'>&larr; Prev<br>
    narratica: Story Consultant</a></p>
  <p class='nav next'><a href='fall_in_friends' title='Fall in Friends: An App to Transform Japan's Inbound Tourism for the Tokyo Olympics'>Next &rarr;<br>
    Fall in Friends: An App to Tra...</a></p>
</nav>
