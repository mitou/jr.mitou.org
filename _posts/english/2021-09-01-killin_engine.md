...
<nav>
  <p class='nav prev'><a href='anyget' title='>>Anyget/ Bulletin Board Style Novel Writing Support Tool'>&larr; Prev<br>
    &gt;&gt;Anyget/ Bulletin Board Style...</a></p>
  <p class='nav next'><a href='web_koten' title='Web Solo Exhibition - Exploring Online Exhibition Formats Leveraging the Web'>Next &rarr;<br>
