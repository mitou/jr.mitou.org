...
<nav>
  <p class='nav prev'><a href='color_overlap' title='Color Overlap - A Puzzle Game Using the Three Primary Colors of Light (RGB)'>&larr; Prev<br>
    Color Overlap - A Puzzle Game ...</a></p>
  <p class='nav next'><a href='visible' title='Visible ─ Web Accessibility Diagnosis & Correction Proposal Tool'>Next &rarr;<br>
