...
<nav>
  <p class='nav prev'><a href='papa' title='Proposal for a Web Application to Support Information Sharing and Scheduling in School Settings'>&larr; Prev<br>
    Proposal for a Web Application...</a></p>
  <p class='nav next'><a href='narratica' title='narratica: Story Consultant'>Next &rarr;<br>
    narratica: Story Consultant</a></p>
</nav>
