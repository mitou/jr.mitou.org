...
<nav>
  <p class='nav prev'><a href='vamboo' title='Development of a Visual Programming Language that Introduces the Concept of FRP'>&larr; Prev<br>
    Development of a Visual Progra...</a></p>
  <p class='nav next'><a href='music_reminder' title='Proposal for a Smartphone Application that Recommends Music Based on Personal Experiences'>Next &rarr;<br>
    Proposal for a Smartphone Appl...</a></p>
</nav>
