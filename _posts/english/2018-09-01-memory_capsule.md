...
<nav>
  <p class='nav prev'><a href='robot_soccer' title='Robot Soccer Simulation Using Reinforcement Learning'>&larr; Prev<br>
    Robot Soccer Simulation Using ...</a></p>
  <p class='nav next'><a href='sound_in_the_forest' title='Sound in the forest - Representation of "Moving Sound" Using Multiple Smartphones'>Next &rarr;<br>
