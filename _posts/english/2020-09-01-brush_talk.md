...
<nav>
  <p class='nav prev'><a href='guinfra' title='GUInfra: Building Infrastructure with a GUI'>&larr; Prev<br>
    GUInfra: Building Infrastructu...</a></p>
  <p class='nav next'><a href='spaghetian' title='Spaghetian - Building a CPU Using Only Electricity and Electromagnets'>Next &rarr;<br>
    Spaghetian - Building a CPU Us...</a></p>
</nav>
