...
<nav>
  <p class='nav prev'><a href='camera_translation' title='Camera Translation'>&larr; Prev<br>
    Camera Translation</a></p>
  <p class='nav next'><a href='utips' title='UTIPS - Household Information Sharing Service'>Next &rarr;<br>
