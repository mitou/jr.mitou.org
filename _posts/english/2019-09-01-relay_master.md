...
<nav>
  <p class='nav prev'><a href='manage_stock' title='ManageStock - Inventory Management App for Households'>&larr; Prev<br>
    ManageStock - Inventory Manage...</a></p>
  <p class='nav next'><a href='virtual_presents' title='VirtualPresents - A Web Service for Use in Virtual Worlds'>Next &rarr;<br>
