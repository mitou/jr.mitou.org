...
<nav>
  <p class='nav prev'><a href='fall_in_friends' title='Fall in Friends: An App to Transform Japan's Inbound Tourism for the Tokyo Olympics'>&larr; Prev<br>
    Fall in Friends: An App to Tra...</a></p>
  <p class='nav next'><a href='listenable_keyboard' title='Listening Keyboard'>Next &rarr;<br>
    Listening Keyboard</a></p>
</nav>
