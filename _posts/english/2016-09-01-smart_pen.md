...
<nav>
  <p class='nav prev'><a href='vr_picture_book_maker' title='VR Picture Book Maker'>&larr; Prev<br>
    VR Picture Book Maker</a></p>
  <p class='nav next'><a href='voice_commander' title='Voice Commander: Commands × Poses × Che'>Next &rarr;<br>
