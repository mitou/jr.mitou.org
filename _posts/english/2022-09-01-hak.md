...
<nav>
  <p class='nav prev'><a href='michishirube' title='Smart Guide Cane 'Michishirube' ~ AI-Powered White Cane for Assisting the Visually Impaired ~'>&larr; Prev<br>
    Smart Guide Cane &apos;Michishirube...</a></p>
  <p class='nav next'><a href='nu_desktop' title='NuDesktop - A Lightweight and Flexible Desktop Environment'>Next &rarr;<br>
