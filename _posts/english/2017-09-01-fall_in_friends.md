...
<nav>
  <p class='nav prev'><a href='savacs' title='Monitoring Photo Stand'>&larr; Prev<br>
    Monitoring Photo Stand</a></p>
  <p class='nav next'><a href='draw_code' title='DrawCode: Create HTML Freely by Connecting Blocks'>Next &rarr;<br>
