...
<nav>
  <p class='nav prev'><a href='spaghetian' title='Spaghetian - Building a CPU Using Only Electricity and Electromagnets'>&larr; Prev<br>
    Spaghetian - Building a CPU Us...</a></p>
  <p class='nav next'><a href='poet' title='Poet ~A Creative Tool for Poets~'>Next &rarr;<br>
    Poet ~A Creative Tool for Poet...</a></p>
</nav>
