...
<nav>
  <p class='nav prev'><a href='brush_talk' title='Brush Talk: A Communication App for Young Children'>&larr; Prev<br>
    Brush Talk: A Communication Ap...</a></p>
  <p class='nav next'><a href='color_overlap' title='Color Overlap - A Puzzle Game Using the Three Primary Colors of Light (RGB)'>Next &rarr;<br>
    Color Overlap - A Puzzle Game ...</a></p>
</nav>
