...
<nav>
  <p class='nav prev'><a href='birds_eye' title='Birds eye Pi-chan: Bicycle Hazard Prediction App'>&larr; Prev<br>
    Birds eye Pi-chan: Bicycle Haz...</a></p>
  <p class='nav next'><a href='vr_sandbox' title='VRSandbox: An Easy 3D Modeling Tool for Everyone'>Next &rarr;<br>
