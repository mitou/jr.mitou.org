...
layout: post
title: |
  mock up: Video Editing Software Framework
description: |
...
permalink: /english/projects/2021/mock_up
...
<nav>
  <p class='nav prev'>
    <a href='birds_eye' title='Birds eye ぴーちゃん　自転車危険予測アプリ'>
      &larr; {{ translations.navPrev[lang] }}
      <br>
      {% if page.lang == 'en' %}
        Birds eye Pi-chan: Bicycle Haz...
      {% else %}
