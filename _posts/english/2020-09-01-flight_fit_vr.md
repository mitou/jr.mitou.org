...
<nav>
  <p class='nav prev'><a href='rocat' title='Rocat: STEM Education Using Model Rockets'>&larr; Prev<br>
    Rocat: STEM Education Using Mo...</a></p>
  <p class='nav next'><a href='guinfra' title='GUInfra: Building Infrastructure with a GUI'>Next &rarr;<br>
