...
<nav>
  <p class='nav prev'><a href='mark_sdgs' title='Mark Finder! for SDGs'>&larr; Prev<br>
    Mark Finder! for SDGs</a></p>
  <p class='nav next'><a href='telport' title='TELPort: High-Speed Communication Protocol Using Sound Waves and Transmission/Reception Application via Speaker and Microphone'>Next &rarr;<br>
