...
<nav>
  <p class='nav prev'><a href='music_reminder' title='Proposal for a Smartphone Application that Recommends Music Based on Personal Experiences'>&larr; Prev<br>
    Proposal for a Smartphone Appl...</a></p>
  <p class='nav next'><a href='anki_cookie' title='Memory Cookies'>Next &rarr;<br>
    Memory Cookies</a></p>
</nav>
