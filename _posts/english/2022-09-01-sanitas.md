...
<nav>
  <p class='nav prev'><a href='scairecrow' title='scairecrow - A System to Protect Garbage from Crows'>&larr; Prev<br>
    scairecrow - A System to Prote...</a></p>
  <p class='nav next'><a href='study_rec' title='StudyRec - A Learning App to Manage Study Time Using Time-Lapse and Pomodoro Timer'>Next &rarr;<br>
