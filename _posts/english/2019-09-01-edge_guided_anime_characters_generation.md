...
<nav>
  <p class='nav prev'><a href='virtual_presents' title='VirtualPresents - A Web Service for Use in Virtual Worlds'>&larr; Prev<br>
    VirtualPresents - A Web Servic...</a></p>
  <p class='nav next'><a href='mallet' title='Mallet - A Simple Application Development Environment for Mobile Devices'>Next &rarr;<br>
    Mallet - A Simple Application ...</a></p>
</nav>
