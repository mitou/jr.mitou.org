...
layout: post
title: |
  Augment - A Music Game Utilizing Real-Time Scale Estimation
description: |
...
permalink: /english/projects/2021/augment
thumbnail: /assets/img/projects/2021/augment.webp
...
<nav>
  ...
  <p class='nav next'>
    <a href='haniwa' title='Haniwa - 家族間タスク共有&amp;報酬提供アプリ'>
      {{ translations.navNext[lang] }} &rarr;
      <br>
      {% if page.lang == 'en' %}
        Haniwa - Task Sharing and Rewa...
      {% else %}
