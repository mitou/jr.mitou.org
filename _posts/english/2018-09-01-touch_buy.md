...
<nav>
  <p class='nav prev'><a href='corkboard' title='Corkboard - A Location-Based Memo Management Service'>&larr; Prev<br>
    Corkboard - A Location-Based M...</a></p>
  <p class='nav next'><a href='robot_soccer' title='Robot Soccer Simulation Using Reinforcement Learning'>Next &rarr;<br>
