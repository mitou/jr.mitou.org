...
layout: post
title: |
  Tea - Virtual Economy Simulation Platform and Game
description: |
...
permalink: /english/projects/2019/tea
thumbnail: /assets/img/projects/2019/tea.webp
...
<nav>
  ...
  <p class='nav next'>
    <a href='fresh_capsule' title='fresh capsule - 食材管理アプリ'>
      {{ translations.navNext[lang] }} &rarr;
      <br>
      {% if page.lang == 'en' %}
        fresh capsule - Food Managemen...
      {% else %}
