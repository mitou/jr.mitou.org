...
layout: post
title: |
  >>Anyget/ Bulletin Board Style Novel Writing Support Tool
description: |
...
permalink: /english/projects/2021/anyget
thumbnail: /assets/img/projects/2021/anyget.webp
...
<nav>
  <p class='nav prev'>
    <a href='puguette' title='パゲット - 全て3Dプリントされた四足歩行ロボット'>
      &larr; {{ translations.navPrev[lang] }}
      <br>
      {% if page.lang == 'en' %}
        Puguette - A Fully 3D-Printed ...
      {% else %}
  ...
  <p class='nav next'>
    <a href='killin_engine' title='KillinEngine -マルチプレイ型ゲーム制作エンジン-'>
      {{ translations.navNext[lang] }} &rarr;
      <br>
      {% if page.lang == 'en' %}
        KillinEngine - A Multiplayer G...
      {% else %}
