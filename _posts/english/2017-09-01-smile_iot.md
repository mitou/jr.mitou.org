...
<nav>
  <p class='nav prev'><a href='listenable_keyboard' title='Listening Keyboard'>&larr; Prev<br>
    Listening Keyboard</a></p>
  <p class='nav next'><a href='vamboo' title='Development of a Visual Programming Language that Introduces the Concept of FRP'>Next &rarr;<br>
