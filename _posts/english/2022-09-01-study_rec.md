...
<nav>
  <p class='nav prev'><a href='sanitas' title='Sanitas: An App Supporting Beauty and Health by Sharing Effort Data'>&larr; Prev<br>
    Sanitas: An App Supporting Bea...</a></p>
  <p class='nav next'><a href='craftere_post' title='CrafterePost - A Web Service for Sharing 3D Minecraft Structures'>Next &rarr;<br>
