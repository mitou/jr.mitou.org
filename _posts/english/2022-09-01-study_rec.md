...
layout: post
title: |
  StudyRec - A Learning App to Manage Study Time Using Time-Lapse and Pomodoro Timer
description: |
...
permalink: /english/projects/2022/study_rec
thumbnail: /assets/img/projects/2022/study_rec.webp
twitter_card: summary_large_image

---

{% assign pj           = site.data.projects | where_exp: "pj", "pj.id == 'study_rec'" | first %}
...
<nav>
  ...
  <p class='nav next'>
    <a href='craftere_post' title='CrafterePost - Minecraft建築物3D共有Webサービス'>
      {{ translations.navNext[lang] }} &rarr;
      <br>
      {% if page.lang == 'en' %}
        CrafterePost - A Web Service f...
      {% else %}
        CrafterePost - Minecraft建築物3D共...
      {% endif %}
    </a>
  </p>
</nav>
