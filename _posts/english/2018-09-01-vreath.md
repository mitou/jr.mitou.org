...
layout: post
title: |
  Vreath - Development of a Unique Consensus Algorithm to Lower Barriers to Acquiring Cryptocurrency
description: |
  Developing a Consensus Algorithm to Enable Easy Acquisition of Cryptocurrency for Everyone through a New Blockchain.

permalink: /english/projects/2018/vreath
thumbnail: /assets/img/projects/2018/vreath.webp
...
<nav>
  ...
  <p class='nav next'>
    <a href='corkboard' title='Corkboard - 位置的に管理するメモサービス'>
      {{ translations.navNext[lang] }} &rarr;
      <br>
      {% if page.lang == 'en' %}
        Corkboard - A Location-Based M...
      {% else %}
