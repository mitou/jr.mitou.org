...
<nav>
  <p class='nav prev'><a href='fluxel' title='Fluxel - Development and Application of a Magnetic Levitation Linear Electromagnetic Acceleration Launcher'>&larr; Prev<br>
    Fluxel - Development and Appli...</a></p>
  <p class='nav next'><a href='motion_rapid' title='Motion Rapid - A Tool for Creating CSS Animations with a Video Editing Software-like UI'>Next &rarr;<br>
