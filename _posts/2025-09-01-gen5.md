...
permalink: /projects/2025/gen5
thumbnail: /assets/img/projects/2025/gen5.webp
twitter_card: summary_large_image

---

{% assign pj           = site.data.projects | where_exp: "pj", "pj.id == 'gen5'" | first %}
...
<nav>
  ...
  <p class='nav next'>
    <a href='sr_motor_heart' title='人工心臓に応用するためのシンクロナスリラクタンスモーターの開発'>
