...
<nav>
  <p class='nav prev'><a href='flight_fit_vr' title='-Flight Fit VR- 「飛行」をテーマに仮想空間で身体を鍛えるVR作品'>&larr; 前<br>
    -Flight Fit VR- 「飛行」をテーマに仮想空間で...</a></p>
  <p class='nav next'><a href='brush_talk' title='ぶらっしゅとーく〜小さな子どものための筆談アプリ〜'>次 &rarr;<br>
