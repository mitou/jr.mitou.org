...
<div style='display: flex; flex-wrap: wrap'>
  ...
  <a href="https://twitter.com/intent/tweet?text='聞く'キーボード&via=MitouJr&hashtags=未踏ジュニア&related=MitouJr&lang=jp&url={{ site.url }}/projects/2017/listenable_keyboard" class="button" target="_blank" rel="noopener">ツイートする</a>
</div>
