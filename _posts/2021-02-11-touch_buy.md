...
thumbnail: /assets/img/thumbnails/2018/touch_buy.png
...
{% else %}                         data-src='/assets/img/thumbnails/2018/touch_buy.png'
...
<div style='display: flex; flex-wrap: wrap'>
  ...
  <a href="https://twitter.com/intent/tweet?text=TouchBuy - VRにおけるECの在り方の模索&via=MitouJr&hashtags=未踏ジュニア&related=MitouJr&lang=jp&url={{ site.url }}/projects/2018/touch_buy" class="button" target="_blank" rel="noopener">ツイートする</a>
</div>
