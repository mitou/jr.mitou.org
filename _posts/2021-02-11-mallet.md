...
<div style='display: flex; flex-wrap: wrap'>
  ...
  <a href="https://twitter.com/intent/tweet?text=Mallet - モバイル端末用簡易アプリ開発環境&via=MitouJr&hashtags=未踏ジュニア&related=MitouJr&lang=jp&url={{ site.url }}/projects/2019/mallet" class="button" target="_blank" rel="noopener">ツイートする</a>
</div>
