...
thumbnail: /assets/img/thumbnails/2021/birds_eye.webp
...
<nav>
  <p class='nav prev'><a href='web_koten' title='Web個展 - Webであることを活かしたオンライン展示形式の模索'>&larr; 前<br>
    Web個展 - Webであることを活かしたオンライン展示形式...</a></p>
  <p class='nav next'><a href='mock_up' title='mock up: 動画編集ソフトウェアフレームワーク'>次 &rarr;<br>
