...
thumbnail: /assets/img/thumbnails/2020/levo.webp
...
<nav>
  <p class='nav prev'><a href='force_book' title='ForceBook - つよつよ自作ノートPC'>&larr; 前<br>
    ForceBook - つよつよ自作ノートPC</a></p>
  <p class='nav next'><a href='rocat' title='Rocat ～モデルロケットを使ったSTEM教育～'>次 &rarr;<br>
