...
thumbnail: /assets/img/thumbnails/2017/draw_code.webp
...
<nav>
  <p class='nav prev'><a href='fall_in_friends' title='Fall in Friends ～東京オリンピックに向けて、日本のインバウンドを変えるアプリを作る ～'>&larr; 前<br>
    Fall in Friends ～東京オリンピックに向けて、...</a></p>
  <p class='nav next'><a href='listenable_keyboard' title=''聞く'キーボード'>次 &rarr;<br>
    &apos;聞く&apos;キーボード</a></p>
</nav>
