...
<nav>
  <p class='nav prev'><a href='fluxel' title='Fluxel - 磁気浮上式リニア電磁加速投射機の開発と応用'>&larr; 前<br>
    Fluxel - 磁気浮上式リニア電磁加速投射機の開発と応用...</a></p>
  <p class='nav next'><a href='motion_rapid' title='Motion Rapid - 動画編集ソフトのようなUIでCSSアニメーションを作成するツール'>次 &rarr;<br>
