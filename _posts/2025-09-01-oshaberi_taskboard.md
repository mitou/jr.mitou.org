...
description: |
  スマホを持たない子どもや高齢者でも扱える、アナログ的な操作でデジタル管理できる忘れ防止装置。タスク管理を楽しく続けられるよう工夫し、自己管理の定着を支援します。
permalink: /projects/2025/oshaberi_taskboard
thumbnail: /assets/img/projects/2025/taskboard.jpg
...
<nav>
  ...
  <p class='nav next'>
    <a href='mathmosis' title='Mathmosis - 数学学習支援AIを搭載したタブレット向けアプリ'>
      ...
      {% else %}
        Mathmosis - 数学学習支援AIを搭載したタブレット向けア...
      {% endif %}
    </a>
  </p>
</nav>
