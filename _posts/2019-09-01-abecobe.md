...
thumbnail: /assets/img/thumbnails/2019/abecobe.webp
...
<div style="display: table; border-collapse: separate; border-spacing: 15px 0; font-size: 70%; width: 100%; padding: 10px 10px; margin-top: 100px; background-color: rgb(40, 161, 58);">
  <p class="nav prev">&larr; 前<br><a href='neulot'>neulot - 生体信号を用いたインターフェイスの開発</a></p>
  <p class="nav next">次 &rarr;<br><a href='manage_stock'>ManageStock - 家庭向け在庫管理アプリ</a></p>
</div>
